...
{phang}
{bf:causaldata} {hline 2} Lists information about data in the causaldata package
...
{p 8 17 2}
{cmd:causaldata}, [d(string)]

{synoptset 20 tabbed}{...}
{synopthdr}
{synoptline}
{syntab:Main}
{synopt:{opt d(string)}} Provide information about which data set? Omit this option to get a list of data set names.
