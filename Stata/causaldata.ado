...
prog def causaldata
	...
	if "`d'" == "" {
		...
		di as error "{stata sysuse abortion.dta, clear}"
		...
		di as error "{stata sysuse adult_services.dta, clear}"
		...
		di as error "{stata sysuse avocado.dta, clear}"
		...
		di as error "{stata sysuse black_politicians.dta, clear}"
		...
		di as error "{stata sysuse castle.dta, clear}"
		...
		di as error "{stata sysuse close_elections_lmb.dta, clear}"
		...
		di as error "{stata sysuse close_college.dta, clear}"
		...
		di as error "{stata sysuse cps_mixtape.dta, clear}"
		...
		di as error "{stata sysuse credit_cards.dta, clear}"
		...
		di as error "{stata sysuse gapminder.dta, clear}"
		...
		di as error "{stata sysuse google_stock.dta, clear}"
		...
		di as error "{stata sysuse gov_transfers.dta, clear}"
		...
		di as error "{stata sysuse gov_transfers_density.dta, clear}"
		di as text "Source: Manacorda, M., Miguel, E. and Vigorito, A., 2011. Government transfers and political support. American Economic Journal: Applied Economics, 3(3), pp.1-28."
		di ""
		di "Used in the Regression Discontinuity chapter in The Effect by Huntington-Klein"
		di ""
		...
		di as error "{stata sysuse greek_data.dta, clear}"
		...
		di as error "{stata sysuse mortgages.dta, clear}"
		...
		di as error "{stata sysuse Mroz.dta, clear}"
		...
		di as error "{stata sysuse nhefs.dta, clear}"
		...
		di as error "{stata sysuse nhefs_complete.dta, clear}"
		di as text "Source: wwwn.cdc.gov/nchs/nhanes/nhefs/"
		di ""
		di "Used in Causal Inference by Hernán and Robins"
		di ""
		...
		di as error "{stata sysuse nsw_mixtape.dta, clear}"
		...
		di as error "{stata sysuse organ_donations.dta, clear}"
		...
		di as error "{stata sysuse restaurant_inspections.dta, clear}"
		...
		di as error "{stata sysuse ri.dta, clear}"
		...
		di as error "{stata sysuse scorecard.dta, clear}"
		...
		di as error "{stata sysuse snow.dta, clear}"
		...
		di as error "{stata sysuse social_insure.dta, clear}"
		...
		di as error "{stata sysuse thornton_hiv.dta, clear}"
		...
		di as error "{stata sysuse texas.dta, clear}"
		...
		di as error "{stata sysuse titanic.dta, clear}"
		...
		di as error "{stata sysuse training_bias_reduction.dta, clear}"
		di as text "Source: Cunningham, Scott. 2021. Causal Inference: The Mixtape. Yale Press. https://mixtape.scunning.com/index.html."
		di ""
		di "Used in the Matching and Subclassification chapter in Causal Inference: the Mixtape by Cunningham."
		di ""
		...
		di as error "{stata sysuse training_example.dta, clear}"
		di as text "Source: Cunningham, Scott. 2021. Causal Inference: The Mixtape. Yale Press. https://mixtape.scunning.com/index.html."
		di ""
		di "Used in the Matching and Subclassification chapter in Causal Inference: the Mixtape by Cunningham."
		di ""
		...
		di as error "{stata sysuse yule.dta, clear}"
